    ...
    return <Container direction={'row'}>
        ...
        <FlexContainer direction={'column'}>
            ...
            <p>Software Engineer based in London with over 8 years’ experience in the software development industry.
                Over this period, I have worked in various teams and gathered knowledge in various technologies to implement and maintain applications for financial reporting,
                budgeting, analytics and BIM data on both web and desktop applications.
